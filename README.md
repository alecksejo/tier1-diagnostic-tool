...
## Background
As I study for my CompTIA A+, I wanted to build something practical that mirrors what happens in a real help desk environment. Manually collecting system info during a support ticket waste time. This python script automates that process and saves everything into a clean text file report in seconds. 
